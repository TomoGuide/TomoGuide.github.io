...
If you are using the downloaded test dataset this would be the `gain1_links` and `gain2_links` folders.
...
The distance will appear in the dialogue box. Here **106 pixels** (this is actually a bin4 tomogram shown here) or 81 nm.

<a href="/imgs/20_ali1.JPG" data-lightbox="image-gallery">
  <img src="/imgs/20_ali1.JPG" alt="Processing Workflow" style="width:60%;">
</a>

For the Aretomo file, we need to provide the distance in unbinned pixels. So 106 bin4 pixels would be 424 unbinned pixels (or 810 Å / 1.91 Å/pixels = 424 unbinned pixels).
