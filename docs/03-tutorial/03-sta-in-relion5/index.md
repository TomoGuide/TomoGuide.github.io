...
- **Input images STAR file**: Use the *_data.star file generated by the previous **3Dclass** job. E.g, if you liked iteration 9 you have to use <kbd>run_it009_data.star</kbd> as input.
