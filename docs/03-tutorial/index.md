...
**Start by going to the [Dataset, Software and Resources](/07-dataset-software-resources/) tab and make sure you download all the necessary software and the dataset.**
